...
/// A custom text field that can be used throughout the app.
///
/// Highlight feature: Custom validation options.
...
class MyTextFieldState extends State<MyTextField> {
  ...
  /// The style of this text field's border.
  ...
  /// The type of soft keyboard that will appear on screen for the user.
